...
class MinesGame:
    ...
    def reveal_cell(self, cell_index):
        ...
        if self.mine_count == 1:
            self.multiplier = round(self.base_multiplier ** safe_opened, 2)
        else:
            base_log = math.log(self.mine_count, 5)
            self.multiplier = round(base_log + safe_opened, 2)
